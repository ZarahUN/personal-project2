...
public class ThreePlayerHandTest {
	...
	static Logger logger = Logger.getLogger(DeckTest.class.getName());
	 ...
	 @Before
	  ...
	  {		  
          ...
          logger.info(String.format("ThreePlayerHandTest Before"));
	  }
	

	@Test
	public void player1HandTest(){
		logger.info(String.format("ThreePlayerHandTest: confirm player 1 hand"));
	...
	public void player2HandTest(){
		logger.info(String.format("ThreePlayerHandTest: confirm player 2 hand"));
	...
	public void player3HandTest(){
		logger.info(String.format("ThreePlayerHandTest: confirm player 3 hand"));
	...
	public void stateTestP1(){
		logger.info(String.format("ThreePlayerHandTest: confirm card states for player 1"));
	...
	public void stateTestP2(){
		logger.info(String.format("ThreePlayerHandTest: confirm card states for player 2"));
	...
	public void stateTestP3(){
		logger.info(String.format("ThreePlayerHandTest: confirm card states for player 3"));
